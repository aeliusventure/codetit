...
function setLabels() {
	Ti.API.info('SET LABELS');
	$.toggleOptBtnLabel.setText("オプション情報");
    $.toggleOptBtnMarkLabel.applyProperties({ text: Alloy.Globals.UI.font.fontAwesome.icon('fa-plus-square-o') });
    Ti.API.info('WinOpen ===== オプション情報');
}
